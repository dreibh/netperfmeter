...
%build
%cmake -DCMAKE_INSTALL_PREFIX:PATH=/usr -DCMAKE_INSTALL_SYSCONFDIR:PATH=/etc -DWITH_ICONS=ON -DWITH_PLOT_PROGRAMS=ON -DWITH_EXAMPLE_SCRIPTS=ON -DWITH_EXAMPLE_RESULTS=ON
%cmake_build
...
- New upstream release.
* Wed Jul 01 2026 Thomas Dreibholz <dreibh@simula.no> - 2.0.8-1
- New upstream release.
* Tue Jun 23 2026 Thomas Dreibholz <dreibh@simula.no> - 2.0.7-1
- New upstream release.
* Fri Jun 12 2026 Thomas Dreibholz <dreibh@simula.no> - 2.0.6-1
- New upstream release.
* Fri May 29 2026 Thomas Dreibholz <dreibh@simula.no> - 2.0.5-1
- New upstream release.
* Thu May 28 2026 Thomas Dreibholz <dreibh@simula.no> - 2.0.4-1
- New upstream release.
* Tue May 05 2026 Thomas Dreibholz <dreibh@simula.no> - 2.0.3-1
- New upstream release.
