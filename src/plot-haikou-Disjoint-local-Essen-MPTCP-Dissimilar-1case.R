...
# ------ Plotter Settings ---------------------------------------------------
simulationDirectory  <- "haikou-Disjoint-local-Essen-MPTCP-Dissimilar" 
...
plotConfigurations <- list(
   ...
   list(simulationDirectory, paste(sep="", simulationDirectory, "-ReceivedBitRate.pdf"),
        "100/10MBit/s-South10ms,0loss-90ms", NA, NA, list(1,0.5),
        "SndBuf", "passive.flow-ReceivedBitRate-Mbit",
        "CMTCCVariant", "DelayNorthernTrail", "ReferenceFlowProtocol",
        "LossNorthernTrail", "RateSouthernTrail", "DelaySouthernTrail",
        "TRUE", 
