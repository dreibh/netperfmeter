...
netPerfMeterPlotVariables <- list(
   ...
   list("OptionRP",              "CMT-RP{G}"),
   list("OptionCMT",             "Allow CMT {:mu:}"),
   list("OptionDAC",             "Delayed Ack CMT {:delta:}"),
   list("OptionNRSACK",          "Use NR-SACK{:nu:}"),
   list("SndBuf",                "Send Buffer{S}[Bytes]"),
   list("RcvBuf",                "Receive Buffer{R}[Bytes]"),
   list("InitialCwnd",           "Initial Cwnd {:omega:}[Bytes]"),
   ...
   list("RateSouthernTrail",
           "Data Rate on Southern Trail{:rho[South]:}[Kbit/s]"),
